...
<section class="vh-100 text-light text-center m-0 p-0">
    ...
    <h3 class="bottom align-text-bottom pb-5">Nothing about us, without us</h3>
</section>

<?php
require_once('./utilities/autres_composants/section_about.php');
require_once('./utilities/autres_composants/section_publication.php')
?>
