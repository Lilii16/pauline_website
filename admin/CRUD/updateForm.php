    ...
    <div class="card decoration-none">
        <?php if ($type === 'question') { ?>
            <form action="updateElement.php" method="post" class="row justify-content-center col-6">
                ...
                <textarea name="reponse"  class="form-control" id="exampleFormControlTextarea1" rows="3"> <?= isset($question['reponse']) ? $question['reponse'] : '' ?> </textarea><br>
