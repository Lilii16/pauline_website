...
<section id="honoraires-section" class="py-5 section_juridique" style="overflow: hidden;">
  ...
  <div class="rotate-10 bg-red blur-red p-5 mt-5">
    <div class="m-auto">
<div class="container col-md-6 py-md-5 rotate-20 border border-light border-3 row m-auto">
        <p class="h5 text-red text-break text-light text-center p-md-5 py-4">
